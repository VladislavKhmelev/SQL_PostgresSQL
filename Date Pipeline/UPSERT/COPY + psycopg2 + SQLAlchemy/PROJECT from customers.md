...
#!!!!
logging.basicConfig(
    filename=r"C:\Users\Vladislav X\Desktop\etl_project\data\UPSERT\version3\logs\etl_customers.log",
    level=logging.INFO,
...
#!!!!!!!!!
error_df.to_csv(
    r"C:\Users\Vladislav X\Desktop\etl_project\data\UPSERT\version4\data\Error\error_customers.csv",
    index=False
)
...
# !!!!!!!
clean_df.to_csv(
    r"C:\Users\Vladislav X\Desktop\etl_project\data\UPSERT\version4\data\clean_customers.csv",
    index=False
)
