...
# ROLLBACK;
#
# то здесь транзакцией управляет сам PostgreSQL через SQL-команды.


То есть:

BEGIN → PostgreSQL начинает транзакцию.
выполняются SQL-команды;
COMMIT → PostgreSQL фиксирует изменения;
ROLLBACK → PostgreSQL отменяет изменения.
-- ============================================================
-- 2. RAW
-- ============================================================
