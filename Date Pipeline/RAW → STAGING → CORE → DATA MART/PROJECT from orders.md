...
1,1,101,5000,completed,2026-09-01
2,2,102,7000,completed,2026-09-01
3,1,103,3000,cancelled,2026-09-01
4,3,104,8000,completed,2026-09-02
5,5,105,4500,completed,2026-09-02
6,8,106,6200,completed,2026-09-03
7,7,107,3500,pending,2026-09-03
8,4,108,1500,cancelled,2026-09-04
9,9,109,-500,completed,2026-09-04
10,10,110,9000,completed,2026-09-05
11,999,111,4000,completed,2026-09-05
12,2,112,6000,unknown,2026-09-05
...
logging.basicConfig(
    filename=r"C:\Users\Vladislav X\Desktop\proj\ver2\logs\etl_orders.log",
    level=logging.INFO,
...
df = pd.read_csv(
    r"C:\Users\Vladislav X\Desktop\proj\ver2\data\orders.csv",
...
try:
    ...
    with connection.cursor() as cursor:
        ...
        cursor.execute("""
            CREATE TEMP TABLE validated_orders AS
            SELECT
                *,
                NULLIF(
                    CONCAT_WS(
